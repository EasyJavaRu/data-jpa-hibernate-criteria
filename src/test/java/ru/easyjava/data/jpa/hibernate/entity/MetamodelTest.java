...
public class MetamodelTest {
    ...
    public void testGreeter() {
        ...
        passportOwnerCriteria.where(cb.equal(ownerPassportRoot.get(Passport_.owner).get(Person_.lastName), "Testoff"));
        ...
        passportLikeCriteria.where(cb.like(likePassportRoot.get(Passport_.owner).get(Person_.lastName), "Te%"));
        ...
        Join<Person, Company> company = personWorkRoot.join(Person_.workingPlaces);
